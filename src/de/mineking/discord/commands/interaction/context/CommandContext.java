...
public abstract class Context<Event extends GenericCommandInteractionEvent> {
	public final ExecutionData<Event, ? extends Context<Event>> data;
	...
	public Context(ExecutionData<Event, ? extends Context<Event>> data) {
		this.data = data;
